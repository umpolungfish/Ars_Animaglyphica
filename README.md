...
```bash
pip install -e .
ars-anima types | ars-anima type VIII | ars-anima animal <name>
ars-anima distance <a> <b> | ars-anima list [type] | ars-anima elaborate <name> | ars-anima lattice
```

Full 323-line version (lattice, pairs, cross-domain bridge, credits): `README_backups/Ars_Animaglyphica_README.md`.
