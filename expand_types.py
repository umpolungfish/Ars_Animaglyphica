...
lines.append("  ⊙ (criticality / aposematic self-modeling), H (chirality),")
...
lines.append("")
lines.append('PRIM_KEYS = ["D","T","R","Phi","f","C","Gamma","G","⊙","H","Sigma","Omega"]')
lines.append('DISCRIMINANT_KEYS = ["T","C","Gamma","G","⊙","H","Sigma","Omega"]')
